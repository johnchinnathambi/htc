...
import useCityStatesHook from "../../../api/cityStates";
import {
  Spinner,
  ViewCityStates,
  Pagination,
...
const CityStates = () => {
  ...
  const { data, isLoading, isError, error, refetch } = getCityStates;
  ...
  const editHandler = (CityState) => {
    ...
    setValue("menu", CityState.menu);
    setValue("path", CityState.path);
    setValue("description", CityState.description);
  };

  return (
    <>
      <Helmet>
        <title>Cities and States | HTC</title>
        <meta property="og:title" content="Cities and States" key="title" />
      </Helmet>
      {isSuccessDelete && (
